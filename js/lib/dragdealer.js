/* Note: I had to modify this file: 's/Position/DragdealerPosition/g'. */
/**
 * Dragdealer.js 0.9.6
...
var Dragdealer = function(wrapper, options) {
   ...
   *
   *
   * DragdealerPositioning in Dragdealer:
   *
...
Dragdealer.prototype = {
  ...
  setWrapperOffset: function() {
    this.offset.wrapper = DragdealerPosition.get(this.wrapper);
  },
  ...
  startDrag: function() {
    ...
    this.offset.mouse = [
      Cursor.x - DragdealerPosition.get(this.handle)[0],
      Cursor.y - DragdealerPosition.get(this.handle)[1]
    ];
  },
  stopDrag: function() {
  ...
  updateOffsetFromValue: function() {
    ...
    if (!this.groupCompare(this.offset.current, this.offset.prev)) {
      this.renderHandleDragdealerPosition();
      this.groupCopy(this.offset.prev, this.offset.current);
    }
  },
  renderHandleDragdealerPosition: function() {
